...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jszostek-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/sci"
  #   chef.validation_client_name = "sci-validator"
  #   chef.validation_key_path = ".chef/sci-validator.pem"
  # end
end
